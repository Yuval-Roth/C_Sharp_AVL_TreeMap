...
/// ===================
/// </summary>
public sealed class TreeMap<K,V> : IEnumerable<MapEntry<K,V>> where K : IComparable
{
    ...
    {
        return new TreeMap_InOrder_EntrySet_Enumerator(this);
    }

    IEnumerator<MapEntry<K, V>> IEnumerable<MapEntry<K, V>>.GetEnumerator()
    {
        return new TreeMap_InOrder_EntrySet_Enumerator(this);
    }
    ...
    public class TreeMap_InOrder_EntrySet_Enumerator : IEnumerator<MapEntry<K,V>>
    {
        TreeMapNode initialPosition;
        TreeMapNode? current;
        TreeMapNode? next;
        public TreeMap_InOrder_EntrySet_Enumerator(TreeMap<K, V> tree)
        {
        ...
        public object Current => new MapEntry<K, V>(current.Key, current.Value);

        MapEntry<K, V> IEnumerator<MapEntry<K, V>>.Current => new MapEntry<K, V>(current.Key,current.Value);
